...
// import { Orders, OrderStatus } from '@/types'; // <-- Tipe ini perlu didefinisikan di roommasterb
import { useDebouncedValue } from '@mantine/hooks';
import { IconSearch } from '@tabler/icons-react';
import ErrorAlert from '@/components/ErrorAlert'; // <-- Jalur diperbaiki

// Tipe data dummy (gantilah dengan tipe dari '@/types' jika sudah ada)
export type OrderStatus = 'shipped' | 'processing' | 'cancelled' | 'pending';
export type Orders = {
  id: string;
  product: string;
  date: string;
