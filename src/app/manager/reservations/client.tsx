// src/app/manager/reservations/client.tsx
'use client';
  ...
  return (
    <DatesProvider settings={{ locale: 'id', firstDayOfWeek: 1, weekendDays: [0] }}>
      <style dangerouslySetInnerHTML={{ __html: `
        .manager-segmented-control .mantine-SegmentedControl-label[data-active] {
          color: #ffffff !important;
          font-weight: 600;
        }
        .manager-segmented-control .mantine-SegmentedControl-label:hover {
          color: var(--mantine-color-gray-9);
        }
        .manager-segmented-control .mantine-SegmentedControl-label[data-active]:hover {
          color: #ffffff !important;
        }
      `}} />
