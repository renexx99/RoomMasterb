...
const navItems: NavItem[] = [
  ...
  { label: 'Tipe Kamar', icon: IconCategory, href: '/manager/room-types' }, // Nanti read-only
  { label: 'Manajemen Kamar', icon: IconBed, href: '/manager/rooms' },       // Nanti akses terbatas
  ...
  useEffect(() => {
    const fetchHotelInfo = async () => {
      if (!assignedHotelId) {
        ...
        console.warn("Hotel Manager profile does not have an assigned hotel_id in roles.");
    ...
    if (!authLoading && profile) { // Hanya fetch jika auth selesai loading dan profile ada
      fetchHotelInfo();
        ...
        <Group h="100%" px="md" justify="space-between">
          <Group>
            ...
            <Group gap="xs">
              ...
              <Box>
                ...
                <Badge size="xs" color="blue" variant="light"> {/* Badge berbeda? */}
                  {managerRoleName}
                </Badge>
              </Box>
            </Group>
          ...
          <Menu shadow="md" width={200}>
            <Menu.Target>
              <UnstyledButton>
                <Group gap="xs">
                  <Avatar color="blue" radius="xl"> {/* Warna avatar berbeda? */}
      ...
      >
            ...
            return (
              <NavLink
                ...
                // Styling NavLink (bisa disamakan dengan admin/layout atau sedikit dibedakan)
                 styles={{
                  root: {
                    borderRadius: rem(8), marginBottom: rem(4), padding: rem(12),
                    fontSize: rem(14), fontWeight: 500,
                    ...
                    "&[dataActive]": {
                      background: 'linear-gradient(135deg, rgba(59, 130, 246, 0.1) 0%, rgba(37, 99, 235, 0.1) 100%)', // Gradien biru
                      color: '#3b82f6',
                      fontWeight: 600,
        ...
        <AppShell.Section>
          <NavLink
            ...
            styles={{ /* ... styling sama seperti admin/layout ... */
               root: {
                borderRadius: rem(8), padding: rem(12), fontSize: rem(14), fontWeight: 500,
                color: '#ef4444', transition: 'all 0.25s ease',
                '&:hover': { background: 'rgba(239, 68, 68, 0.08)', boxShadow: '0 2px 6px rgba(239, 68, 68, 0.15)' },
              },
             }}
          />
        </AppShell.Section>
