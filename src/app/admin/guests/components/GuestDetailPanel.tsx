...
export function GuestDetailPanel({ guest, onEdit }: Props) {
  ...
  const aiSuggestions = [
    { text: 'Offer Suite upgrade (78% probability)', color: 'violet', icon: IconSparkles },
    { text: 'Previously complained about noisy AC - ensure quiet room', color: 'red', icon: IconBolt },
  ];
            ...
            <Box p="xl" style={{ background: 'linear-gradient(135deg, #14b8a6 0%, #0891b2 100%)', color: 'white' }}>
                ...
                <SimpleGrid cols={3} mt="xl" spacing="lg">
                    ...
                    <Box style={{ borderRight: '1px solid rgba(255,255,255,0.2)' }}>
                        ...
                        <Text size="xl" fw={700}>IDR {Number(guest.total_spend || 0).toLocaleString('en-US')}</Text>
                    </Box>
                    <Box>
                        ...
                        <Stack gap="md">
                            ...
                            <Card padding="md" radius="md" withBorder>
                                ...
                                <Group gap="xs">
                                    ...
                                    )) : <Text c="dimmed" size="sm" fs="italic">No recorded preferences.</Text>}
                                </Group>
                            </Card>
                        </Stack>
                    </Grid.Col>
                        ...
                        <Card padding="md" radius="md" withBorder h="100%">
                            ...
                            {history.length > 0 ? (
                                    ...
                                    {history.map((h) => (
                                        ...
                                        >
                                            ...
                                            <Badge size="sm" color="teal" variant="light" mt="xs">
                                                Total: IDR {h.total_price?.toLocaleString('en-US')}
                                            </Badge>
                                        </Timeline.Item>
                                    ))}
                                </Timeline>
                                ...
                                <Stack align="center" justify="center" py="xl" gap="xs">
                                    ...
                                    <Text c="dimmed" size="sm">No stay history yet.</Text>
                                </Stack>
                            )}
                        </Card>
                    </Grid.Col>
