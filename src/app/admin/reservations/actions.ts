...
export async function createReservation(data: ReservationData) {
  ...
  // Update status kamar menjadi occupied jika check-in hari ini (opsional, tergantung logika bisnis)
  // Untuk saat ini kita hanya insert reservasi.
...
// Action khusus untuk membuat Guest baru dan langsung mengembalikan ID-nya
// (Digunakan saat user memilih "Tamu Baru" di form reservasi)
