  ...
  return (
    <DatesProvider settings={{ locale: 'id', firstDayOfWeek: 1, weekendDays: [0] }}>
        ...
        <Modal opened={modalOpened} onClose={handleCloseModal} title={editingReservation ? 'Edit Reservasi' : 'Buat Reservasi Baru'} centered size="lg" >
            ...
            <Stack gap="md">
                <Group grow> <Button variant={guestSelectionMode === 'select' ? 'filled' : 'outline'} onClick={() => setGuestSelectionMode('select')} color="teal"> Reservasi </Button> <Button variant={guestSelectionMode === 'new' ? 'filled' : 'outline'} onClick={() => setGuestSelectionMode('new')} color="teal"> Tamu </Button> </Group>
