                            ...
                            >
                              ...
                              <Group justify="space-between" align="center">
                                <Text size="xs" c="dimmed">
                                  IDR {rt.price_per_night.toLocaleString('en-US')}
                                </Text>
                                {rt.bed_type && (
                    ...
                    <Box p="lg" style={{ background: 'white', borderBottom: '1px solid #e9ecef' }}>
                      <Group justify="space-between" align="flex-start">
                        <div>
                          ...
                          <Text size="xl" fw={700} c="teal.7" mt={4}>
                            IDR {selectedType.price_per_night.toLocaleString('en-US')} 
                      ...
                      <Box p="lg">
                        <Grid gutter="lg">
                          ...
                          <Grid.Col span={{ base: 12, md: 4 }}>
                             <Paper p="md" radius="md" withBorder h="100%" bg="teal.0" style={{ borderColor: 'var(--mantine-color-teal-2)' }}>
                                <Stack align="center" justify="center" h="100%" gap="sm" py="xl">
                                   <ThemeIcon size={64} radius="xl" variant="white" color="teal">
                                      <IconCoin size={32} />
                                   </ThemeIcon>
                                   <Text size="sm" ta="center" c="teal.9" px="md">
                                      This type sets the base price standard. Ensure competitive pricing for your market.
                                   </Text>
                                   <Button variant="white" color="teal" size="xs" onClick={() => handleEdit(selectedType)}>
                                      Update Price
                                   </Button>
                                </Stack>
                             </Paper>
                  ...
                  <Stack gap="md" h="100%">
                    <Grid gutter="md">
                        ...
                        <Grid.Col span={4}>
                            <Paper p="md" radius="md" withBorder>
                                ...
                                <Text size="xl" fw={700}>IDR {stats.avgPrice.toLocaleString('en-US')}</Text>
                            </Paper>
                        </Grid.Col>
                        <Grid.Col span={4}>
                            <Paper p="md" radius="md" withBorder>
                    ...
                    >
                      <Stack align="center" gap="lg" p="xl"> {/* Added padding and increased gap */}
                        ...
                        <Button mt="xl" size="md" color="teal" leftSection={<IconPlus size={18}/>} onClick={handleCreate}>
                            Create New Type
                        </Button>
                      </Stack>
                    </Paper>
