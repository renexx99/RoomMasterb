...
export default function TaBookRoomClient({ roomTypeOptions, hotelId, hotelName, agentId }: Props) {
  ...
  const prefilledRoomTypeName = searchParams.get('roomTypeName');
  ...
  return (
    <Box p="xl">
      ...
      <Group justify="space-between" align="flex-end" mb="xl" wrap="wrap">
        <Stack gap={2}>
          ...
          <Text size="sm" c="dimmed">
            {hotelName} — Create a booking for your guest
          </Text>
        </Stack>
        <Button
          variant="subtle"
      ...
      >
        ...
        {prefilledRoomTypeName && (
          <Text size="xs" c="dimmed" mb="md">
            Pre-selected from availability: {prefilledRoomTypeName}
          </Text>
        )}
        ...
        {roomTypeId && nights > 0 && (
          ...
          >
            <Text size="xs" fw={700} c="dimmed" tt="uppercase" mb="xs" style={{ letterSpacing: '0.04em' }}>
        ...
        <Textarea
          placeholder="e.g., Late check-in after 23:00, extra bed required, honeymoon setup..."
          value={remarks}
